...
if [[ "${TOMCAT_ENABLE_MOD_CLUSTER:-true}" == "true" ]]; then
    ...
    sed -i "s~@TOMCAT_MOD_CLUSTER_ADVERTISE_INTERFACE@~${TOMCAT_MOD_CLUSTER_ADVERTISE_INTERFACE:-${TOMCAT_CONNECTOR_ADDRESS:-${HOSTNAME}}}~g" ${TC_CONF_DIR}/server.xml
...
if [[ "${TOMCAT_ENABLE_HTTPS_CONNECTOR:-true}" == "true" ]]; then
    ...
    sed -i "s~@TOMCAT_HTTPS_CONNECTOR_ADDRESS@~${TOMCAT_HTTPS_CONNECTOR_ADDRESS:-${TOMCAT_CONNECTOR_ADDRESS:-${HOSTNAME}}}~g" ${TC_CONF_DIR}/server.xml
...
if [[ "${TOMCAT_ENABLE_HTTP_CONNECTOR:-true}" == "true" ]]; then
    ...
    sed -i "s~@TOMCAT_HTTP_CONNECTOR_ADDRESS@~${TOMCAT_HTTP_CONNECTOR_ADDRESS:-${TOMCAT_CONNECTOR_ADDRESS:-${HOSTNAME}}}~g" ${TC_CONF_DIR}/server.xml
...
if [[ "${TOMCAT_ENABLE_AJP_CONNECTOR:-true}" == "true" ]]; then
    ...
    sed -i "s~@TOMCAT_AJP_CONNECTOR_ADDRESS@~${TOMCAT_AJP_CONNECTOR_ADDRESS:-${TOMCAT_CONNECTOR_ADDRESS:-${HOSTNAME}}}~g" ${TC_CONF_DIR}/server.xml
